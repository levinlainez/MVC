...
public class ActivityConsulta extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Llamar a la conexion de db Sqlite
    ...
    private void Buscar() {
        ...
        String [] fields ={Transacciones.nombres,Transacciones.apellidos, Transacciones.correo, Transacciones.edad, Transacciones.direccion};
        String wherecond =Transacciones.id+"=?";
